...
checkPageAccessWithRedirect('admin/settings/safety_reports/edit.php');
...
// Get safety report data
$safety_report = getSafetyReportById($id);
if (!$safety_report) {
    header('Location: index.php');
    exit();
}

// Check if user can edit this report (admin/manager or creator)
if (!hasAnyRole(['admin', 'manager']) && $safety_report['created_by'] != $user['id']) {
    header('Location: index.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['report_type'])) {
        ...
        if (updateSafetyReport($id, $data)) {
            $success_message = "Safety report updated successfully.";
            // Refresh the data
            $safety_report = getSafetyReportById($id);
        } else {
            $error_message = "Failed to update safety report. Please try again.";
        }
    }
}
?>
...
<head>
    ...
    <title>Edit Safety Report - <?php echo PROJECT_NAME; ?></title>
                    ...
                    <div class="flex justify-between items-center py-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                Update safety report: <?php echo htmlspecialchars($safety_report['report_title']); ?>
                            </p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="report_type" required 
                                        ...
                                        <option value="Incident Report" <?php echo ($safety_report['report_type'] === 'Incident Report') ? 'selected' : ''; ?>>Incident Report</option>
                                        <option value="Near Miss" <?php echo ($safety_report['report_type'] === 'Near Miss') ? 'selected' : ''; ?>>Near Miss</option>
                                        <option value="Hazard Report" <?php echo ($safety_report['report_type'] === 'Hazard Report') ? 'selected' : ''; ?>>Hazard Report</option>
                                        <option value="Safety Concern" <?php echo ($safety_report['report_type'] === 'Safety Concern') ? 'selected' : ''; ?>>Safety Concern</option>
                                        <option value="Equipment Failure" <?php echo ($safety_report['report_type'] === 'Equipment Failure') ? 'selected' : ''; ?>>Equipment Failure</option>
                                        <option value="Environmental" <?php echo ($safety_report['report_type'] === 'Environmental') ? 'selected' : ''; ?>>Environmental</option>
                                        <option value="Other" <?php echo ($safety_report['report_type'] === 'Other') ? 'selected' : ''; ?>>Other</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="report_no" 
                                           value="<?php echo htmlspecialchars($safety_report['report_no'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="submit_on_behalf_of" 
                                           value="<?php echo htmlspecialchars($safety_report['submit_on_behalf_of'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="report_title" required 
                                           value="<?php echo htmlspecialchars($safety_report['report_title']); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="event_date_time" 
                                           value="<?php echo $safety_report['event_date_time'] ? date('Y-m-d\TH:i', strtotime($safety_report['event_date_time'])) : ''; ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="event_base" 
                                           value="<?php echo htmlspecialchars($safety_report['event_base'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="event_department" 
                                           value="<?php echo htmlspecialchars($safety_report['event_department'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="status" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                        <option value="draft" <?php echo ($safety_report['status'] === 'draft') ? 'selected' : ''; ?>>Draft</option>
                                        <option value="submitted" <?php echo ($safety_report['status'] === 'submitted') ? 'selected' : ''; ?>>Submitted</option>
                                        <option value="under_review" <?php echo ($safety_report['status'] === 'under_review') ? 'selected' : ''; ?>>Under Review</option>
                                        <option value="resolved" <?php echo ($safety_report['status'] === 'resolved') ? 'selected' : ''; ?>>Resolved</option>
                                        <option value="closed" <?php echo ($safety_report['status'] === 'closed') ? 'selected' : ''; ?>>Closed</option>
                                    </select>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="report_description" rows="4" 
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"><?php echo htmlspecialchars($safety_report['report_description'] ?? ''); ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="reporter_name" required 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_name']); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="reporter_address_line_1" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_address_line_1'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="reporter_address_line_2" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_address_line_2'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="reporter_suburb" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_suburb'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="reporter_state" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_state'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="reporter_postcode" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_postcode'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="reporter_country" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_country'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="reporter_telephone" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_telephone'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="reporter_fax" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_fax'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="reporter_email" 
                                           value="<?php echo htmlspecialchars($safety_report['reporter_email'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="confidential" id="confidential" 
                                               <?php echo $safety_report['confidential'] ? 'checked' : ''; ?>
