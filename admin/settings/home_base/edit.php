...
checkPageAccessWithRedirect('admin/settings/home_base/edit.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['location_name'])) {
        ...
        if (updateHomeBase($id, $data)) {
            $success_message = "Home base updated successfully.";
            // Refresh the data
            $home_base = getHomeBaseById($id);
        } else {
            $error_message = "Failed to update home base. Please try again.";
        }
    }
}
?>
...
<head>
    ...
    <title>Edit Home Base - <?php echo PROJECT_NAME; ?></title>
                    ...
                    <div class="flex justify-between items-center py-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                Update home base information for <?php echo htmlspecialchars($home_base['location_name']); ?>
                            </p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="location_name" required 
                                           value="<?php echo htmlspecialchars($home_base['location_name']); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="short_name" 
                                           value="<?php echo htmlspecialchars($home_base['short_name'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="timezone" 
                                           value="<?php echo htmlspecialchars($home_base['timezone'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="publish_no" 
                                           value="<?php echo htmlspecialchars($home_base['publish_no'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="last_survey" 
                                           value="<?php echo htmlspecialchars($home_base['last_survey'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="pending_changes" rows="3" 
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"><?php echo htmlspecialchars($home_base['pending_changes'] ?? ''); ?></textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="site_properties" rows="3" 
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"><?php echo htmlspecialchars($home_base['site_properties'] ?? ''); ?></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="gps_coordinates" 
                                           value="<?php echo htmlspecialchars($home_base['gps_coordinates'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" step="any" name="latitude" 
                                           value="<?php echo htmlspecialchars($home_base['latitude'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" step="any" name="longitude" 
                                           value="<?php echo htmlspecialchars($home_base['longitude'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" step="any" name="magnetic_variation" 
                                           value="<?php echo htmlspecialchars($home_base['magnetic_variation'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="address_line_1" 
                                           value="<?php echo htmlspecialchars($home_base['address_line_1'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="address_line_2" 
                                           value="<?php echo htmlspecialchars($home_base['address_line_2'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="city_suburb" 
                                           value="<?php echo htmlspecialchars($home_base['city_suburb'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="state" 
                                           value="<?php echo htmlspecialchars($home_base['state'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="postcode" 
                                           value="<?php echo htmlspecialchars($home_base['postcode'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="country" 
                                           value="<?php echo htmlspecialchars($home_base['country'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="owned_by_base" 
                                           value="<?php echo htmlspecialchars($home_base['owned_by_base'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="status" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                        <option value="active" <?php echo ($home_base['status'] === 'active') ? 'selected' : ''; ?>>Active</option>
                                        <option value="inactive" <?php echo ($home_base['status'] === 'inactive') ? 'selected' : ''; ?>>Inactive</option>
                                    </select>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="slot_coordination" rows="3" 
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"><?php echo htmlspecialchars($home_base['slot_coordination'] ?? ''); ?></textarea>
                                </div>
                                
                                <div class="md:col-span-2">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="published" id="published" 
                                               <?php echo $home_base['published'] ? 'checked' : ''; ?>
