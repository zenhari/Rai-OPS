...
checkPageAccessWithRedirect('admin/users/personnel_recency/edit.php');
...
// Get the record
$record = getPersonnelRecencyById($record_id);
if (!$record) {
    header('Location: index.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (updatePersonnelRecency($record_id, $data)) {
        $message = 'Personnel recency record updated successfully.';
        header('Location: index.php?message=' . urlencode($message));
        exit();
    } else {
        $error = 'Failed to update personnel recency record.';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Edit Personnel Recency - <?php echo PROJECT_NAME; ?></title>
                    ...
                    <div class="flex justify-between items-center py-4">
                        <div>
                            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                <i class="fas fa-edit mr-2"></i>Edit Personnel Recency
                            </h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                Update personnel recency record information
                            </p>
                        </div>
                    ...
                    <form method="POST" class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" 
                                       value="<?php echo htmlspecialchars($_POST['first_name'] ?? $record['FirstName'] ?? ''); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" id="last_name" name="last_name" 
                                       value="<?php echo htmlspecialchars($_POST['last_name'] ?? $record['LastName'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" 
                                       value="<?php echo htmlspecialchars($_POST['name'] ?? $record['Name'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.1" id="recency_personnel_item_id" name="recency_personnel_item_id" 
                                       value="<?php echo htmlspecialchars($_POST['recency_personnel_item_id'] ?? $record['RecencyPersonnelItemID'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" id="recency_item_id" name="recency_item_id" 
                                       value="<?php echo htmlspecialchars($_POST['recency_item_id'] ?? $record['RecencyItemID'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" id="personnel_id" name="personnel_id" 
                                       value="<?php echo htmlspecialchars($_POST['personnel_id'] ?? $record['PersonnelID'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="type_code" name="type_code" 
                                       value="<?php echo htmlspecialchars($_POST['type_code'] ?? $record['TypeCode'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" id="last_updated" name="last_updated" 
                                       value="<?php echo htmlspecialchars($_POST['last_updated'] ?? ($record['LastUpdated'] ? date('Y-m-d\TH:i', strtotime($record['LastUpdated'])) : '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" id="expires" name="expires" 
                                       value="<?php echo htmlspecialchars($_POST['expires'] ?? ($record['Expires'] ? date('Y-m-d\TH:i', strtotime($record['Expires'])) : '')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" id="value" name="value" 
                                       value="<?php echo htmlspecialchars($_POST['value'] ?? $record['Value'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" id="doc_id" name="doc_id" 
                                       value="<?php echo htmlspecialchars($_POST['doc_id'] ?? $record['DocID'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="doc_name" name="doc_name" 
                                       value="<?php echo htmlspecialchars($_POST['doc_name'] ?? $record['DocName'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.1" id="home_base_id" name="home_base_id" 
                                       value="<?php echo htmlspecialchars($_POST['home_base_id'] ?? $record['HomeBaseID'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" id="home_department_id" name="home_department_id" 
                                       value="<?php echo htmlspecialchars($_POST['home_department_id'] ?? $record['HomeDepartmentID'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="primary_department_name" name="primary_department_name" 
                                       value="<?php echo htmlspecialchars($_POST['primary_department_name'] ?? $record['PrimaryDepartmentName'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="base_name" name="base_name" 
                                       value="<?php echo htmlspecialchars($_POST['base_name'] ?? $record['BaseName'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="base_short_name" name="base_short_name" 
                                       value="<?php echo htmlspecialchars($_POST['base_short_name'] ?? $record['BaseShortName'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="integration_reference_code" name="integration_reference_code" 
                                       value="<?php echo htmlspecialchars($_POST['integration_reference_code'] ?? $record['IntegrationReferenceCode'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="cf_master" name="cf_master" 
                                   <?php echo (isset($_POST['cf_master']) || $record['CFMaster']) ? 'checked' : ''; ?>
