...
checkPageAccessWithRedirect('admin/fleet/routes/add.php');
        ...
        if (!empty($missing_fields)) {
            ...
            if ($data['origin_station_id'] == $data['destination_station_id']) {
                ...
                if (createRoute($data)) {
                    ...
                    $error = 'Failed to add route. Please check if route code already exists.';
                }
            }
        }
    }
...
<head>
    ...
    <title>Add Route - <?php echo PROJECT_NAME; ?></title>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add New Route</h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Create a new flight route between stations</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="route_code" name="route_code" required
                                       ...
                                       placeholder="e.g., THR-ISF" value="<?php echo htmlspecialchars($_POST['route_code'] ?? ''); ?>">
                            ...
                            <div>
                                ...
                                <input type="text" id="route_name" name="route_name" required
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="e.g., Tehran to Isfahan" value="<?php echo htmlspecialchars($_POST['route_name'] ?? ''); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select id="origin_station_id" name="origin_station_id" required
                                    ...
                                    <?php foreach ($stations as $station): ?>
                                        <option value="<?php echo $station['id']; ?>" 
                                                <?php echo (isset($_POST['origin_station_id']) && $_POST['origin_station_id'] == $station['id']) ? 'selected' : ''; ?>>
                            ...
                            <div>
                                ...
                                <select id="destination_station_id" name="destination_station_id" required
                                    ...
                                    <?php foreach ($stations as $station): ?>
                                        <option value="<?php echo $station['id']; ?>" 
                                                <?php echo (isset($_POST['destination_station_id']) && $_POST['destination_station_id'] == $station['id']) ? 'selected' : ''; ?>>
                                            <?php echo htmlspecialchars($station['station_name'] . ' (' . $station['iata_code'] . ')'); ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" id="distance_nm" name="distance_nm"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="180.50" value="<?php echo htmlspecialchars($_POST['distance_nm'] ?? ''); ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="flight_time_minutes" name="flight_time_minutes"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="60" value="<?php echo htmlspecialchars($_POST['flight_time_minutes'] ?? ''); ?>">
                            ...
                            <div>
                                ...
                                <input type="text" id="frequency" name="frequency"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="Daily, Mon-Fri, Weekly" value="<?php echo htmlspecialchars($_POST['frequency'] ?? ''); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="hidden" id="aircraft_types" name="aircraft_types" value="<?php echo htmlspecialchars($_POST['aircraft_types'] ?? ''); ?>">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                      placeholder="Additional notes about this route..."><?php echo htmlspecialchars($_POST['notes'] ?? ''); ?></textarea>
                        </div>
                    </div>
