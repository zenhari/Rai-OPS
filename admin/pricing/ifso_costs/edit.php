...
checkPageAccessWithRedirect('admin/pricing/ifso_costs/edit.php');
...
// Get IFSO cost ID
$ifsoCostId = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
// Get IFSO cost information
$db = getDBConnection();
$stmt = $db->prepare("SELECT * FROM ifso_costs WHERE id = ?");
$stmt->execute([$ifsoCostId]);
$ifsoCost = $stmt->fetch(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (updateIFSOCost($ifsoCostId, $monthlyPrepayment, $salaries, $salariesCount, $training, $trainingCount, $transport, $transportCount, $ifsoPremium, $ifsoPremiumCount, $monthlyAccommodation, $monthlyAccommodationCount)) {
        $message = 'IFSO Cost updated successfully.';
        // Refresh the page to show updated data
        header('Refresh: 1');
    } else {
        $error = 'Failed to update IFSO Cost.';
    }
    
    // Re-fetch IFSO cost data after update
    $stmt = $db->prepare("SELECT * FROM ifso_costs WHERE id = ?");
    $stmt->execute([$ifsoCostId]);
    $ifsoCost = $stmt->fetch(PDO::FETCH_ASSOC);
}
...
<head>
    ...
    <title>Edit IFSO Cost - <?php echo PROJECT_NAME; ?></title>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit IFSO Cost</h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Update IFSO cost record</p>
                        </div>
                        <a href="index.php" 
                    ...
                    <form method="POST" class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="number" id="monthly_prepayment" name="monthly_prepayment" step="0.01" min="0"
                                       value="<?php echo htmlspecialchars($ifsoCost['monthly_prepayment']); ?>"
                            ...
                            <div>
                                ...
                                <input type="number" id="salaries" name="salaries" step="0.01" min="0"
                                       value="<?php echo $ifsoCost['salaries'] !== null ? htmlspecialchars($ifsoCost['salaries']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="salaries_count" name="salaries_count" min="0"
                                       value="<?php echo $ifsoCost['salaries_count'] !== null ? htmlspecialchars($ifsoCost['salaries_count']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="training" name="training" step="0.01" min="0"
                                       value="<?php echo $ifsoCost['training'] !== null ? htmlspecialchars($ifsoCost['training']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="training_count" name="training_count" min="0"
                                       value="<?php echo $ifsoCost['training_count'] !== null ? htmlspecialchars($ifsoCost['training_count']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="transport" name="transport" step="0.01" min="0"
                                       value="<?php echo $ifsoCost['transport'] !== null ? htmlspecialchars($ifsoCost['transport']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="transport_count" name="transport_count" min="0"
                                       value="<?php echo $ifsoCost['transport_count'] !== null ? htmlspecialchars($ifsoCost['transport_count']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="ifso_premium" name="ifso_premium" step="0.01" min="0"
                                       value="<?php echo $ifsoCost['ifso_premium'] !== null ? htmlspecialchars($ifsoCost['ifso_premium']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="ifso_premium_count" name="ifso_premium_count" min="0"
                                       value="<?php echo $ifsoCost['ifso_premium_count'] !== null ? htmlspecialchars($ifsoCost['ifso_premium_count']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="monthly_accommodation" name="monthly_accommodation" step="0.01" min="0"
                                       value="<?php echo $ifsoCost['monthly_accommodation'] !== null ? htmlspecialchars($ifsoCost['monthly_accommodation']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="monthly_accommodation_count" name="monthly_accommodation_count" min="0"
                                       value="<?php echo $ifsoCost['monthly_accommodation_count'] !== null ? htmlspecialchars($ifsoCost['monthly_accommodation_count']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
