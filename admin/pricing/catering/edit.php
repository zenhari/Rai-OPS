...
checkPageAccessWithRedirect('admin/pricing/catering/edit.php');
...
// Get catering ID
$cateringId = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
$stmt->execute([$cateringId]);
$catering = $stmt->fetch(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        if (updateCatering($cateringId, $name, $customName, $passengerFood, $equipment, $transportation, $storage, $waste, $qualityInspection, $packaging, $specialServices)) {
    ...
    // Re-fetch catering data after update
    $stmt = $db->prepare("SELECT * FROM catering WHERE id = ?");
    $stmt->execute([$cateringId]);
    $catering = $stmt->fetch(PDO::FETCH_ASSOC);
}
...
<head>
    ...
    <title>Edit Catering - <?php echo PROJECT_NAME; ?></title>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Catering</h1>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Update catering cost configuration</p>
                        </div>
                        <a href="index.php" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select id="name" name="name" required
                                    ...
                                    <option value="Economy" <?php echo $catering['name'] === 'Economy' ? 'selected' : ''; ?>>Economy</option>
                                    <option value="VIP" <?php echo $catering['name'] === 'VIP' ? 'selected' : ''; ?>>VIP</option>
                                    <option value="CIP" <?php echo $catering['name'] === 'CIP' ? 'selected' : ''; ?>>CIP</option>
                                    <option value="Custom" <?php echo $catering['name'] === 'Custom' ? 'selected' : ''; ?>>Custom</option>
                                </select>
                            </div>

                            <!-- Custom Name (only when Custom is selected) -->
                            <div class="md:col-span-2" id="customNameContainer" style="display: <?php echo $catering['name'] === 'Custom' ? 'block' : 'none'; ?>;">
                                ...
                                <input type="text" id="custom_name" name="custom_name"
                                       value="<?php echo htmlspecialchars($catering['custom_name'] ?? ''); ?>"
                                       placeholder="Enter custom catering name"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                       <?php echo $catering['name'] === 'Custom' ? 'required' : ''; ?>>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="passenger_food" name="passenger_food" step="0.01" min="0"
                                       value="<?php echo $catering['passenger_food'] !== null ? htmlspecialchars($catering['passenger_food']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="equipment" name="equipment" step="0.01" min="0"
                                       value="<?php echo $catering['equipment'] !== null ? htmlspecialchars($catering['equipment']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="transportation" name="transportation" step="0.01" min="0"
                                       value="<?php echo $catering['transportation'] !== null ? htmlspecialchars($catering['transportation']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="storage" name="storage" step="0.01" min="0"
                                       value="<?php echo $catering['storage'] !== null ? htmlspecialchars($catering['storage']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="waste" name="waste" step="0.01" min="0"
                                       value="<?php echo $catering['waste'] !== null ? htmlspecialchars($catering['waste']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="quality_inspection" name="quality_inspection" step="0.01" min="0"
                                       value="<?php echo $catering['quality_inspection'] !== null ? htmlspecialchars($catering['quality_inspection']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="packaging" name="packaging" step="0.01" min="0"
                                       value="<?php echo $catering['packaging'] !== null ? htmlspecialchars($catering['packaging']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="special_services" name="special_services" step="0.01" min="0"
                                       value="<?php echo $catering['special_services'] !== null ? htmlspecialchars($catering['special_services']) : ''; ?>"
                                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
