-- ============================================
-- SIMPLE VERSION: Just execute these commands
-- Ignore errors about "does not exist" - just continue
-- ============================================

-- STEP 1: Try to drop foreign keys (ignore errors)
...
-- STEP 2: Try to drop indexes (ignore errors)
...
-- STEP 3: Rename fields (This is the IMPORTANT part - execute each separately)
