...
-- Execute EACH command separately in phpMyAdmin
-- If you get an error "does not exist", just ignore it and continue
-- ============================================

-- ============================================
-- STEP 1: Drop Foreign Keys
-- Execute each line separately. If error "does not exist", just continue to next line
-- ============================================

-- Run these one by one (ignore errors if foreign key doesn't exist):
...
-- Run these one by one (ignore errors if index doesn't exist):
...
-- IMPORTANT: Execute each ALTER TABLE command separately
-- ============================================
...
-- Crew4 (DH) - Note: DH_role doesn't exist, so we create Crew4_role
...
-- Execute as one command (or separately if you get errors)
-- ============================================
